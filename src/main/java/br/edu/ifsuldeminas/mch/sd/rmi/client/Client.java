...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Raiz Quadrada: " + calc.sqrt(16));
            System.out.println("Raiz Cúbica: " + calc.cbrt(27));
            System.out.println("Raiz Quarta: " + calc.sqrt4(16));
            System.out.println("Raiz Quinta: " + calc.sqrt5(243));
            System.out.println("Potência: " + calc.pow(2, 3));
            System.out.println("Porcentagem: " + calc.percent(200, 15));
            System.out.println("Módulo: " + calc.mod(10, 3));
            System.out.println("Fatorial: " + calc.factorial(5));

            List<String> lastOperations = calc.lastOperations(4);
